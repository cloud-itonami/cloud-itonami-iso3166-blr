(ns marketentry.phase
  "Phase 0->3 staged rollout for the Belarus (BLR) market-entry
  compliance actor.
  ...
  real portal package (goszakupki.by/icetrade.by and/or
  zakupki.butb.by) and submitting a real portal registration are the
